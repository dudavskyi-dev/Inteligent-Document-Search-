...
$logPath = Join-Path $spikeRoot "logs\setup_gliner.log"
...
try {
    & $python -m pip install --editable ".[gliner]" *>&1 |
...
Write-Host "GLiNER dependencies were installed into the project-local .venv."
Write-Host "The model will be downloaded into the project-local .cache by the benchmark."
