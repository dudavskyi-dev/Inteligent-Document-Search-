...
$logPath = Join-Path $spikeRoot "logs\setup_retrieval.log"
...
try {
    & $python -m pip install --editable ".[retrieval]" *>&1 |
...
Write-Host "Retrieval dependencies were installed into the project-local .venv."
Write-Host "The embedding model will be downloaded into the project-local .cache by the benchmark."
